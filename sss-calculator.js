    ...
    <div class="qrow">
      <div class="qrow-main">
        ...
        <div class="qrow-meta">
          ...
          ${addr ? `<span class="sep">·</span><span>${escapeHtml(addr)}</span>` : ''}
