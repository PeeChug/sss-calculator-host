...
function showCustomerSuccess(result, isCallback) {
  ...
  if (isCallback) {
    ...
    if (leadEl) leadEl.innerHTML = "We've also texted and emailed you a secure link to view, approve, and place the deposit. Tap the button below to open it now — our team may reach out about your quote.";
  }
