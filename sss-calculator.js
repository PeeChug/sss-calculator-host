  ...
  if (p.selectedDiscounts && p.selectedDiscounts.length) {
    ...
    if (discountList.length) {
      ...
      if (projDiscountAmount > 0) {
        lines.push('');
        lines.push(`  💸 You're saving $${projDiscountAmount.toFixed(2)} on this line item.`);
      }
