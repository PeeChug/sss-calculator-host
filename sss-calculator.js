...
const DISCOUNTS = [
  ...
  { id: 'senior',         label: 'Senior (65+)',                   sub: 'For homeowners 65 and over. Mutually exclusive with Veteran/First Responder and Teacher — pick one.', rate: 0.05, group: 'service_appreciation',
    img: 'https://images.unsplash.com/photo-1447008189669-eb1cd3c70cfb?w=400&q=80&auto=format&fit=crop' },
...
function toggleBulkMode() {
  ...
  if (btn) {
    ...
    btn.textContent = dashState.bulkMode ? '✕ Exit Select Mode' : '☑️ Select Multiple';
  }
  renderDashboard();
}
