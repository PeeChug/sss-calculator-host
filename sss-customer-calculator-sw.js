...
function renderTierCards() {
  ...
  __doc.getElementById('tierCards').innerHTML = ['essential', 'performance', 'showcase'].map(t => {
    ...
    // What's Included — real value-adds per tier. SW edition references
    // Sherwin-Williams SuperDeck products and manufacturer protections.
    let included;
    if (product === 'oil' && t === 'essential') {
      // Transparent oil — minimal pigment, basic protection
      included = [
      ...
      included = [
        '✓ <strong>Sherwin-Williams SuperDeck Oil-Based Semi-Solid</strong> — longest-lasting oil in our lineup',
        '✓ Maximum pigment load for strongest UV protection (4–6 yr recoat cycle on fences)',
